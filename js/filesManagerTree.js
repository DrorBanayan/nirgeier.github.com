        ...
        readFile:function() {
            document.querySelector('input[type="file"]').onchange = function(e) {
                ...
                reader.onload = function(e) {
                    ...
                    if (dataView.getString(3, dataView.length - 128) == 'TAG') {
                        var title = dataView.getString(30, dataView.tell());
                        var artist = dataView.getString(30, dataView.tell());
                        var album = dataView.getString(30, dataView.tell());
                        var year = dataView.getString(4, dataView.tell());
                    } else {
                        // no ID3v1 data found.
                    }
                };
